...
<aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto  border-r rtl:border-r-0 rtl:border-l bg-gray-100 rounded-2xl drop-shadow-2xl">
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        <img class="object-cover w-24 h-24 mx-2 rounded-full" src="../image/myprofile.jpg" alt="avatar">
            <form action="/logout" class="d-flex" method="post">
                     @csrf
                  <ul class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200 mt-2 mx-4 font-medium">
                  <li class="">
                  <a class="" href="#">
                        @php
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a  href="/logout" class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
               <span><button class="mx-4 font-medium">Logout</button></span>
            </a>
        </nav>
    </div>
</aside>
