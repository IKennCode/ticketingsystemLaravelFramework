   ...
   <div class="flex flex-col justify-between flex-1 mt-6 ">
      <nav class="text-sm">
         <ul>
            ...
            <li class="relative">
               <a id="settingsToggle" class="flex items-center px-4 py-2 mt-5 text-gray-400 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-700 cursor-pointer" href="#">
                  <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <!-- Dropdown Menu -->
               <ul id="settingsDropdownMenu" class="absolute right-12 mt-2 hidden opacity-0 scale-95">
                  <li>
                     <a class="block px-4 py-2 text-gray-400 hover:bg-gray-100 hover:text-gray-700 rounded" href="/settings/profile">Alpha</a>
                  </li>
                  <li>
                     <a class="block px-4 py-2 text-gray-400 hover:bg-gray-100 hover:text-gray-700 rounded" href="/settings/security">Beta</a>
                  </li>
                  <li>
                     <a class="block px-4 py-2 text-gray-400 hover:bg-gray-100 hover:text-gray-700 rounded" href="/settings/security">Gamma</a>
                  </li>
