<table class="min-w-full table-auto mb-4 border-1 shadow-lg">
    ...
    <tbody class="bg-gray-300">
        ...
        <tr class="hover:bg-gray-100 text-xs">
            <td class="px-2 py-1 whitespace-nowrap">{{ $user->id }}</td>
            ...
            <td class="px-2 py-1 whitespace-nowrap text-center">{{ $user->department }}</td>
            <td class="px-2 py-1 whitespace-nowrap text-center">{{ $user->job_title }}</td>
