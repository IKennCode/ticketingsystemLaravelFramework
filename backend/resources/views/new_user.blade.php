...
<body class="bg-gray-50 min-h-screen  drop-shadow-2xl">
    <div class="flex justify-center items-center h-screen bg-slate-200 bg-gray-100 max-h-screen drop-shadow-3xl">
        <div id="form" class="bg-gray-100 block bg-slate-50 p-6 rounded-2xl shadow-[25px_25px_30px_-24px_rgb(0,0,0,0.6)] max-w-10xl ">
            <form method="POST" action="/users/newuser/add">
                @csrf
                <h2 class=" text-3xl font-semibold my-4">New User</h2>
             
                <div id="fullName" class="w-auto">
                  
                    <div id="firstName" class=" mr-1">
                        <label for="fname" class=" font-semibold">First Name</label><br>
                    ...
                    <div id="lastName" class=" mr-1">
                        <label for="lname" class=" font-semibold">Last Name</label><br>
                 ...
                 <div class="flex flex-row">
                    <div class=" flex w-50 mr-1">
                         <div class="w-1/2 mr-10 mt-4">
                            <label for="gender" class=" font-semibold ml-1">Gender</label>
                        ...
                        <div class=" w-1/2 ml-10 mt-4">
                            <label for="hired_at" class=" font-semibold ml-1">Marital Status</label>
                            <div class="w-1/2 mr-1">
                        ...
                        <div class=" w-40 ml-10 mt-4">
                            <label for="hired_at" class=" font-semibold ml-20">BirthDate</label>
                ...
                <div class="flex flex-row">
                    <div class=" flex w-50 mr-1">
                        ...
                        <div class="w-1/2 mr-10 mt-4">
                            <label for="department" class=" font-semibold">Job Titles</label>
                            <div class="w-1/2 mr-1">
                        ...
                        <div class="w-1/2 mr-10 mt-4">
                            <label for="department" class=" font-semibold">Date Hired</label>
                            <div class="w-1/2 mr-1">
                 ...
                 {{-- <div class="row mb-3">
                        ...
                        <div>
                            <div >
                                <button type="submit" class=" font-semibold mt-10 bg-blue-700 w-full h-10 cursor-pointer text-white rounded-md hover:bg-blue-600 hover:outline outline-2 outline-blue-600 outline-offset-2 text-sm">
                                    Register
                                </button>
                            </div>
                        </div>  
