...
<div class=" flex justify-center h-screen">
    ...
    <div class="w-full h-screen bg-gray-400">
        <div class="bg-gray-700 px-4 py-2 text-white">
            <i class="bi bi-person-hearts"></i> &nbsp; <strong>Ticket View</strong>
        </div>
                ...
                <div class="">
                    <div class="w-full mb-4">
                        <ul class="  w-full mb-4">
                            <li class=" text-gray-50 font-extrabold">
                                <strong></strong>
                            </li>
                            <li class=" text-gray-50 text-xl font-bold">
                                Ticket ID:
                            <li class=" text-amber-200 text-xl font-bold">{{$data->id}}</li>
                            </li>
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="/tickets/resolve" method="post">
                            ...
                            <div class="col-12">
                                <input type="hidden" name="ticket_id" value="{{$data->id}}">
                                <textarea class="form-control" name="resolution" id="resolution" cols="10" rows="5" {{$data->status==3||$data->status==4||$data->status==5 ? "disabled" : ""}}>{{$data->resolution}}</textarea>
